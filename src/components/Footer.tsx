...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Bags Studio", path: "/about" },
    { label: "Benefits of REACH Bags Studio", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    // { label: "Presentations", path: "/presentations" },
    { label: "REACH Bags Studio Images", path: "/rmmimages" },
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="text-2xl font-bold mb-4 block w-fit">
              <span className="text-primary">REACH</span> Bags Studio
            </Link>
            <p className="text-gray-300 max-w-md">
              The REACH Bags Studio
            </p>
